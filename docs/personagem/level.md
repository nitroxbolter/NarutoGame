...
O level representa a maturidade geral do personagem. Ele serve como a base da progressão e define quando o jogador pode acessar conteúdos mais avançados.

## O que o level influencia

- Vida máxima.
- Chakra máximo.
- Requisitos para jutsus e missões.
- Acesso a áreas de progressão.
- Marcação de evolução geral do ninja.
